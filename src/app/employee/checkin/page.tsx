...
// ── Queue tab ─────────────────────────────────────────────────────────────────
function QueueTab({ employee: _employee }: { employee: SessionEmployee }) {
  ...
  function openPinPrompt(entry: CheckInEntry) {
    setPinError(null)
  ...
  async function handlePIN(pin: string) {
    ...
    setPinError(null)
    try {
      // Identify which technician entered their PIN
      ...
      // Mark customer as served by that technician
